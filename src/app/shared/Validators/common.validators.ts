  ...
  static duplicateEmpCode(
    ...
    return (
      ...
      return employeeService
        ...
        .pipe(
          map((exists: boolean) =>
            exists ? { empCodeDuplicate: true } : null,
          ),
        );
    };
  }
  ...
  static duplicateEmpPhone(
    ...
    return (
      ...
      return employeeService
        ...
        .pipe(
          map((exists) =>
            exists ? { empPhoneDuplicate: true } : null,
          ),
        );
    };
  }
  ...
  static duplicateEmpEmail(
    ...
    return (
      ...
      return employeeService
        ...
        .pipe(
          map((exists) =>
            exists ? { empEmailDuplicate: true } : null,
          ),
        );
    };
  }
